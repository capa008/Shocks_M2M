...
;
;
readcol,'/home/arturo/Documentos/shocks_M2M/data/OMNI_HRO_1MIN_244744_icme.txt',date, hour, B, Bx, By, Bz, V, Vx, Vy, Vz, Np, Tp, betta,format='a,a,f,f,f,f,f,f,f,f,f,f',/silent, skipline=76

hour_shock=float(250.57)
hour_ICME_I=float(251.1) 
hour_ICME_F=float(252.66)
...
psfile='/home/arturo/Documentos/shocks_M2M/plots/icme_plot.eps'
	set_plot,'ps'
...
!P.POSITION=[0.10, 0.82, 0.97, 0.97];!P.POSITION=[0.10, 0.80, 0.97, 0.95] 
	plot, tiempo, TS_SMOOTH(B, 10), linestyle=0, thick=5, xtickformat="(A1)", $
	...
	PlotS, [hour_ICME_F, hour_ICME_F], !Y.CRange, linestyle=2, thick=6,  color = cgColor("Turquoise")
	
;-----------------------------------------------------------------------------------------------------------------------------------------
	plot, tiempo, TS_SMOOTH(Bx, 10), linestyle=0, thick=5,xtickformat="(A1)",POS=[0.10, 0.66,  0.97, 0.81], $;POS=[0.10, 0.64, 0.97, 0.79], $
	...
	oplot, tiempo, TS_SMOOTH(By, 10), linestyle=0, thick=5, color=9
	oplot, tiempo, TS_SMOOTH(Bz, 10), linestyle=0, thick=5, color=blue
...
;-----------------------------------------------------------------------------------------------------------------------------------------
	plot, tiempo, TS_SMOOTH(V, 10), linestyle=0, thick=5,xtickformat="(A1)",POS=[0.10, 0.50, 0.97, 0.65], $;POS=[0.10, 0.48,  0.97, 0.63],$		
...
;-----------------------------------------------------------------------------------------------------------------------------------------
	...
	plot, tiempo, TS_SMOOTH(Np, 10) , linestyle=0, thick=5,xtickformat="(A1)",POS=[0.10, 0.34,  0.97, 0.49], $;POS=[0.10, 0.32,  0.97, 0.47], $
	...
	PlotS, [hour_ICME_F, hour_ICME_F], !Y.CRange, linestyle=2, thick=6,  color = cgColor("Turquoise")
;-----------------------------------------------------------------------------------------------------------------------------------------
	plot,tiempo,TS_SMOOTH(Tp, 10), linestyle=0, thick=5,xtickformat="(A1)", POS=[0.10, 0.18, 0.97, 0.33], $;POS=[0.10, 0.16, 0.97, 0.31], $
	...
	PlotS, [hour_ICME_F, hour_ICME_F], !Y.CRange, linestyle=2, thick=6,  color = cgColor("Turquoise")
;-----------------------------------------------------------------------------------------------------------------------------------------
	plot,tiempo,TS_SMOOTH(betta, 10) , linestyle=0, thick=5,POS=[0.10, 0.02,  0.97, 0.17],$;POS=[0.10, 0.16, 0.97, 0.31], $
	ytitle='betta',xtitle='DOY of 2001', charsize=2.0,$
	yrange=[0,4],$
	xstyle=1,ystyle=1,xticks=7,xminor=4,yminor=5,yticks=4
	PlotS, [hour_shock, hour_shock], !Y.CRange, linestyle=2, thick=6, color = cgColor("Dark Red")
	PlotS, [hour_ICME_I, hour_ICME_I], !Y.CRange, linestyle=2, thick=6,  color = cgColor("Turquoise")
	PlotS, [hour_ICME_F, hour_ICME_F], !Y.CRange, linestyle=2, thick=6,  color = cgColor("Turquoise")
;-----------------------------------------------------------------------------------------------------------------------------------------
...
; ===================================================================================================================================================
;	ICME correspond to a group 3, according with the Lan's classification guide
;	2003, 11/06 1920	11/08 0430	11/06 1920 source:Jian, 2016
;
;
readcol,'/home/arturo/Documentos/shocks_M2M/data/OMNI_HRO_1MIN_4005240_icme_gp3.txt',date, hour, B, Bx, By, Bz, V, Vx, Vy, Vz, Np, Tp, betta,format='a,a,f,f,f,f,f,f,f,f,f,f',/silent, skipline=76

hour_shock=float(310.82)
hour_ICME_I=float(310.91) 
hour_ICME_F=float(311.96)
...
psfile='/home/arturo/Documentos/shocks_M2M/plots/icme_gp3_plot.eps'
	set_plot,'ps'
...
;-----------------------------------------------------------------------------------------------------------------------------------------
	...
	ytitle=unit, charsize=2.0, $
	yrange=[0,15],$
	xstyle=1,ystyle=1,xticks=7,xminor=4,yminor=5,yticks=3,YTickFormat='(I3)'
	PlotS, [hour_shock, hour_shock], !Y.CRange, linestyle=2, thick=6, color = cgColor("Dark Red")
	PlotS, [hour_ICME_I, hour_ICME_I], !Y.CRange, linestyle=2, thick=6,  color = cgColor("Turquoise")
	PlotS, [hour_ICME_F, hour_ICME_F], !Y.CRange, linestyle=2, thick=6,  color = cgColor("Turquoise")
;-----------------------------------------------------------------------------------------------------------------------------------------
...
;-----------------------------------------------------------------------------------------------------------------------------------------
	plot,tiempo,TS_SMOOTH(betta, 10) , linestyle=0, thick=5,POS=[0.10, 0.02,  0.97, 0.17],$;POS=[0.10, 0.16, 0.97, 0.31], $
	ytitle='betta',xtitle='DOY of 2003', charsize=2.0,$
	yrange=[0,10],$
